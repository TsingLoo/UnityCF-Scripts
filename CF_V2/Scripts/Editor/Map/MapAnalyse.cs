...
{
    public class MapAnalyse : EditorWindow
    {
        ...
        [MenuItem("Tools/Map Analyse")]
        public static void ShowWindow()
        {
            //Show existing window instance. If one doesn't exist, make one.
            EditorWindow.GetWindow(typeof(MapAnalyse));
        }
        ...
        void DisplayTips()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                MessageType.None);
            EditorGUILayout.HelpBox(
                "In WebGL there is a limit of 4 lights to be drawn on screen at the same time",
                MessageType.None);
            EditorGUILayout.HelpBox(
        ...
        void AnalyzeLevel()
        {
            ...
            foreach (MeshFilter mf in meshFilters)
            {
                ...
                if (!willBeCombined)
                {
                    if (!(mf.GetComponentInParent<PlayerController>() ||
                          mf.GetComponentInParent<BotController>() ||
            ...
            int enemyCount = GameObject.FindObjectsOfType<BotController>().Length;
