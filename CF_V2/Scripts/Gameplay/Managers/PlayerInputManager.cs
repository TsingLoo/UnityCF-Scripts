...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerController, PlayerInputManager>(
                m_PlayerController, this, gameObject);
            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, PlayerInputManager>(m_GameFlowManager, this);
        ...
        public float GetMoveInputX()
        {
            if (CanProcessInput())
            {
                return Input.GetAxisRaw(ButtonNames.Horizontal);
            }
            return 0;
        }
        ...
        public float GetMoveInputY()
        {
            if (CanProcessInput())
            {
                return Input.GetAxisRaw(ButtonNames.Vertical);
            }
            return 0;
        }
        ...
        public Vector3 GetMoveInput()
        {
            if (CanProcessInput())
            {
                Vector3 move = new Vector3(
                    Input.GetAxisRaw(ButtonNames.Horizontal), 0f,
                    Input.GetAxisRaw(ButtonNames.Vertical));
